...
//     //     if(boidIdDataArray.IsCreated)
//     //     {
//     //         boidIdDataArray.Dispose();
//     //     }

//     //     if(boidLocalToWorldArray.IsCreated)
//     //     {
//     //         boidLocalToWorldArray.Dispose();
//     //     }

//     //     if(newBoidPositions.IsCreated)
//     //     {
//     //         newBoidPositions.Dispose();
//     //     }
//     //     base.OnDestroy();
//     // }
...
//         //     boidIdDataArray.Dispose();
//         // }
//         // boidIdDataArray = new NativeArray<BoidIdData>(boidQuery.CalculateEntityCount(),Allocator.TempJob);

//         // if(boidLocalToWorldArray.IsCreated)
//         // {
//         //     boidLocalToWorldArray.Dispose();
//         // }
//         // boidLocalToWorldArray = new NativeArray<LocalToWorld>(boidQuery.CalculateEntityCount(),Allocator.TempJob);

//         // if(newBoidPositions.IsCreated)
//         // {
//         //     newBoidPositions.Dispose();
//         // }
//         // newBoidPositions = new NativeArray<float4x4>(boidQuery.CalculateEntityCount(), Allocator.TempJob);
...
//             })
//             // .WithDisposeOnCompletion(idDataArray)
//             // .WithDisposeOnCompletion(localToWorldArray)
//             // .WithDisposeOnCompletion(newPositions)
//             .Run();
